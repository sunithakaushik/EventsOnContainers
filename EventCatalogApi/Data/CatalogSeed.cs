    ...
    public static class CatalogSeed
    {
        ...
        private static IEnumerable<EventName> GetPreConfiguredEventNames()
        {
            return new List<EventName>
            {
                ...
                new EventName { EventTypeId = 1, EventTopicId = 1, Title = "Social Event", Description = "Neighbourhood Fair",  Price=0.00M, Location="Bothel", Listing="Free", StartDate=new DateTime(2020, 5, 1, 8, 30, 00), EndDate=new DateTime(2020, 5, 1, 15, 30, 00), ImageUrl = "http://externalcatalogbaseurltobereplaced/api/pic/1" },
                ...
                new EventName { EventTypeId = 4, EventTopicId = 6, Title = "Social Event", Description = "Neighbourhood Fair",  Price=0.00M, Location="Bothel", Listing="Free", StartDate=new DateTime(2020, 5, 1, 8, 30, 00), EndDate=new DateTime(2020, 5, 1, 15, 30, 00), ImageUrl = "http://externalcatalogbaseurltobereplaced/api/pic/5" },
                ...
                new EventName { EventTypeId = 4, EventTopicId = 6, Title = "Entertainment", Description = "Media & Music",  Price=0.00M, Location="Bothel", Listing="Free", StartDate=new DateTime(2020, 5, 1, 8, 30, 00), EndDate=new DateTime(2020, 5, 1, 15, 30, 00), ImageUrl = "http://externalcatalogbaseurltobereplaced/api/pic/4" },
                ...
                new EventName { EventTypeId = 5, EventTopicId = 4, Title = "Social Event", Description = "Neighbourhood Fair",  Price=0.00M, Location="Bothel", Listing="Free", StartDate=new DateTime(2020, 5, 1, 8, 30, 00), EndDate=new DateTime(2020, 5, 1, 15, 30, 00), ImageUrl = "http://externalcatalogbaseurltobereplaced/api/pic/15" },
        ...
        /*private static IEnumerable<EventLocation> GetPreConfiguredEventLocations()
        {
            return new List<EventLocation>
            {
                ...
                new EventLocation { Location = "Bothel" },
